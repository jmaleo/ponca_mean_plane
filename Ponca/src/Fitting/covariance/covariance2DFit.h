...
protected:
    ...
    Vector2   m_centroid2D;
    Matrix32  m_P;
    bool m_planeIsReady {false};

public:
    PONCA_EXPLICIT_CAST_OPERATORS(Covariance2D,covariance2D)
...
template < class DataPoint, class _WFunctor, typename T>
    using Covariance2DFit =
        Ponca::Covariance2D<DataPoint, _WFunctor,
